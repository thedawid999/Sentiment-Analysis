...
manuelle Analyse ist zeitaufwendig und wenig sinnvoll.
...
erforderlich (\cite{jurafsky2023}).
...
mit sprachlicher Vielfalt, Tippfehlern und unbekannten Ausdrücken umgehen können 
(\cite{jetbrains2025}).
...
analysiert. Die GitHub-Repository ist unter diesem
\href{https://github.com/thedawid999/Sentiment-Analysis}{Link}
zu finden.
