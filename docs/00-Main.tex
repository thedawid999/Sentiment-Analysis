\documentclass[
11pt, paper=a4,  listof=totocnumbered, ngerman% lists are also included in table of contents
...
\usepackage[ngerman]{babel} % english hyphenations
...
\include{010-Einleitung}
\include{020-Hauptteil}
\include{030-Schluss}
